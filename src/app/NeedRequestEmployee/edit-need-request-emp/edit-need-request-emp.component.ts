...
@Component({
  selector: 'app-edit-need-request-emp',
  templateUrl: './edit-need-request-emp.component.html',
  styleUrls: ['./edit-need-request-emp.component.css']
})
export class EditNeedRequestEmpComponent implements OnInit {
  needRequest: any;
  employees: any;
  categories: any;
  ...
  constructor(private needrequestService: NeedRequestService, private empService: EmployeeService,
    ...
    this.needRequest = { id: 0,CategoryId:0,SubCategoryId:0, EmployeeId: 0, EmployeeName: '', Type: '', needRequestDate: new Date(), Comment: '' }
  }
  ngOnInit(): void {
  ...
  update() {
    this.needRequest.categoryId=Number(this.needRequest.categoryId);
    this.needRequest.subCategoryId=Number(this.needRequest.subCategoryId);
    console.log("categoryId is : ", this.needRequest.categoryId)
    ...
    this.needrequestService.editNeedRequest(this.NeedRequestID, this.needRequest).subscribe(
      res => {
        ...
        this.router.navigate(['/NeedRequestEmp']);
      },
